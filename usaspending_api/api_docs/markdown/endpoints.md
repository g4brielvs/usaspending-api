...
<form name="myform" action="/api/v2/autocomplete/accounts/a/" method="post">
  <button>/api/v2/autocomplete/accounts/a/</button>
</form> |POST| Returns Treasury Account Symbol Availability Type Code (A) filtered by other components provided in the request filter |
